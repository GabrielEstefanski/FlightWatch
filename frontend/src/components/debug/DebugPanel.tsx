    ...
    <div className="fixed bottom-6 right-6 z-50 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl w-[420px] max-h-[calc(100vh-100px)] flex flex-col">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-100 font-medium">System Monitoring</p>
            </div>
          </div>
          <button
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
            ...
            {isConnected ? (
              <>
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-gray-500">SignalR active</div>
                </div>
              ...
              <>
                ...
                <div className="flex-1">
                  <div className="text-sm font-bold text-gray-900">Disconnected</div>
                  <div className="text-xs text-gray-500">SignalR inactive</div>
                </div>
        ...
        <div className="bg-linear-to-r from-gray-50 to-emerald-50/30 rounded-xl p-4">
          <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-3">
            Flights Sample ({Math.min(5, flights.length)})
          </h4>
